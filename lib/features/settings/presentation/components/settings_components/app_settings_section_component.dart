import 'package:shipper/core/core_features/locale/presentation/utils/app_locale.dart';
...
import 'package:shipper/core/core_features/theme/presentation/utils/colors/custom_colors.dart';
...
import 'package:shipper/core/presentation/widgets/custom_tile_component.dart';
import 'package:shipper/core/presentation/widgets/platform_widgets/platform_switch.dart';
import 'package:shipper/features/settings/presentation/components/settings_components/settings_section_component.dart';
          ...
          customTrailing: Container(
            ...
            child: PlatformSwitch(
              ...
              onChanged: (value) {
                ...
                ref.read(appThemeProvider.notifier).changeTheme(changeTheme);
              },
